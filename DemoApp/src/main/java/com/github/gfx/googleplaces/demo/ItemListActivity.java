...
public class ItemListActivity extends FragmentActivity implements ItemListFragment.Callbacks {
     ...
     */
    @Override
    public void onItemSelected(ApiType id) {
        if (mTwoPane) {
            // In two-pane mode, show the detail view in this activity by
            // adding or replacing the detail fragment using a
            // fragment transaction.
            final Bundle arguments = new Bundle();
            arguments.putString(ItemDetailFragment.ARG_ITEM_ID, id.name());
            ...
            detailIntent.putExtra(ItemDetailFragment.ARG_ITEM_ID, id.name());
